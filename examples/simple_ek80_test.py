...
rawfiles = [
    "/home/cermak/glider/raw/unit_507/20220212/fishstick/UAF sample-Phase0-D20220301-T014925-0.raw",
    "/home/cermak/glider/raw/unit_507/20220212/fishstick/UAF sample-Phase0-D20220301-T032108-0.raw",
]
...
raw_data_20 = ek80.get_channel_data(frequencies=200000)
...
raw_data_20_1 = raw_data_20[200000][0]
#                             ^    ^
#                 frequency --|    |-- channel+datatype index

# and to the second....
#raw_data_38_2 = raw_data_38[38000][1]
#raw_data_20_2 = raw_data_20[200000][1]
#                             ^    ^
#                 frequency --|    |-- channel+datatype index
...
#raw_data_20_1.append(raw_data_20_2)
...
echogram_2 = echogram.Echogram(ax_1, raw_data_20_1, 'complex')
...
processed_power_1 = raw_data_20_1.get_power()
...
cal_obj = raw_data_20_1.get_calibration()

# Now request Sv data in time order.
#Sv = raw_data_38_1.get_Sv(calibation=cal_obj)
Sv = raw_data_20_1.get_Sv(calibation=cal_obj)
...
angles_along, angles_athwart = raw_data_20_1.get_physical_angles()
print(angles_along)
